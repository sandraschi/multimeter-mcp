...
const BACKEND_NAME: &str = "multimeter-mcp-backend.exe";
const BACKEND_PORT: u16 = 11005;
const BACKEND_TAG: &str = "multimeter-mcp-backend-x86_64-pc-windows-msvc.exe";
const ENV_PORT: &str = "MULTIMETER_MCP_PORT";
const ENV_HOST: &str = "MULTIMETER_MCP_HOST";
const ENV_TAURI: &str = "MULTIMETER_MCP_TAURI";
